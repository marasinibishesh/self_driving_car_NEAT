...
class NEATManager:
    ...
    def eval_genomes(self, genomes, config):
        ...
        for genome_id, genome in genomes:
            ...
            cars.append(pygame.sprite.GroupSingle(Car(self.current_track)))
            ge.append(genome)
            nets.append(net)
            genome.fitness = 0
    ...
    def run_best_model(self):
        ...
        car = pygame.sprite.GroupSingle(Car(self.current_track))
        track_surface, track_overlay = TRACK_IMAGES[self.current_track]
        ...
        while running:
            ...
            info = [
                ...
                f"Border Color: {car.sprite.border_color}"
            ]
    ...
    def plot_training_progress(self):
        ...
        ax1.set_title(f'Training Progress - {TRACKS[self.current_track]["name"]}')
...
def main_menu():
    ...
    plot_button = Button(SCREEN_WIDTH//2 - 100, 400, 200, 40, "Show Training Plot")
    quit_button = Button(SCREEN_WIDTH//2 - 100, 450, 200, 40, "Quit")
    
    buttons = track_buttons + [train_button, run_button, plot_button, quit_button]
